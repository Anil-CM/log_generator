# Example configuration for generating 100MB+ logs
# Copy this file to terraform.tfvars and adjust values as needed

# For ~100MB logs, use these settings:
...
# For ~50MB logs (faster execution):
...
# For ~200MB+ logs (very large, slow execution):
